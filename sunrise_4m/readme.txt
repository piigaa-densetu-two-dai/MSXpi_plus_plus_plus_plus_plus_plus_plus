Nextor対応！Sunrise IDE + 4096kメモリーマッパーエミュレーターです。
...
2. sunrise_4m.binファイルの後ろに1でダウンロードしたNextorカーネルを連結します。

unixのcatコマンドを使用する例
$ cat sunrise_4m.bin Nextor-2.1.2.SunriseIDE.MasterOnly.ROM > firmware.bin

windowsのcopyコマンドを使用する例
>copy /b sunrise_4m.bin + Nextor-2.1.2.SunriseIDE.MasterOnly.ROM firmware.bin
